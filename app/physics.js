...
// Put physics related stuff into it's own namespace
var physics = {};

// Returns the linear interpolation between a and b
physics.lerp = function(a, b, factor)
{
    return a + factor * (b - a);
};
...
physics.acceleration = function(state, t)
{
    ...
    // Add gravity
    fx += physics.context.gravity.x * mass;
    fy += physics.context.gravity.y * mass;

    // Divide force with mass to get acceleration
    return {x: fx / mass, y: fy / mass};
};

physics.evaluate = function(initial, t, dt, derivative)
{
    var state = {
    ...
    var acc = physics.acceleration(state, t+dt);
...
physics.integrate = function(state, t, dt)
{
    var a = physics.evaluate(state, t, 0, new physics.Derivative());
    var b = physics.evaluate(state, t, dt*0.5, a);
    var c = physics.evaluate(state, t, dt*0.5, b);
    var d = physics.evaluate(state, t, dt, c);
